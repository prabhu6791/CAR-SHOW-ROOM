      ...
      <div class="col-sm-4"></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <Link to='/main'>
              <p class="nav-link" aria-current="page" href="#">Home</p>
              </Link>
            </li>
            <Link to="/inventary">
            <li class="nav-item">
              <p aria-current="page " class="nav-link" >Inventary</p>
            </li>
            </Link>
            <li class="nav-item">
            <Link to='/faq'>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="mt-5   col-sm-6">
            <h1>About us</h1>
            <p>How the adventure ended will be seen anon. Aouda was anxious,
               ...
               <p>During the first days, they went along smoothly enough. The sea was not very unpropitious, the wind seemed stationary in the north-east.</p>
               <p>As for Passepartout, he thought Mr. Fogg’s manoeuvre simply glorious. The captain had said “between eleven and twelve knots,” and the Henrietta confirmed his prediction. How the adventure ended will be seen anon. Aouda was anxious, though she said nothing. As for Passepartout, he thought Mr. Fogg’s manoeuvre simply glorious. The captain had said.</p>
        </div>
        <div class="col-sm-6">
            <img class="m-5 about-img" src={require("../image_src/pexels-photo-1170412.jpeg")}/>
        </div>
      </div>
    </div>
...
<div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6">
            <img class="m-5 " src={require("../image_src/ezgif.com-gif-maker (1).jpg")}/>
        </div>
        <div class="mt-5   col-sm-6">
            {/* <h1>About us</h1> */}
